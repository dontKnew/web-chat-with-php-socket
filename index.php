  ...
  if(isset($_GET['code'])){
    ...
    if($user_object->is_valid_email_verification_code()){
        ...
        if($user_object->enable_user_account()){
          ...
          $error_message = 'Invalid is varification method';
        }
    }else{
          ...
          <div class="card" id="chat2">
            ...
            <div class="card-body">
              ...
              <form action="" method="POST">
                ...
                <div class="col">
                  <!-- Simple link -->
                  <a href="forgetpassword.php" class='text-center text-danger shadow-md'>Are you Forgot password ?</a>
                </div>
            </div>
            <!-- Submit button -->
            <div class="mb-4">
              <button name="submit" name="submit" class="btn btn-warning btn-block">Log in</button><br>
              <span class="mx-4">Don`t have an account ?<a href="register.php" > <u> click here </u></a></span>
            </div>
            </form>
          </div>
        </div>
